...
| 文档 | 作用 | 路径 |
|------|------|------|
| 幽灵通道协议白皮书 v2.0 | 面向 CTO / 架构师的技术白皮书 | `../whitepapers/幽灵通道协议白皮书_v2.0.md` |
| 幽灵通道协议白皮书 高管版 v1.0 | 面向高管的精简版白皮书 | `../whitepapers/幽灵通道协议白皮书_高管版_v1.0.md` |
| 幽灵通道协议 PoC 验证方案 v1.0 | PoC 场景与验证设计 | `../deliverables/幽灵通道协议_PoC验证方案_v1.0.md` |
| 幽灵通道协议 应用价值深度探索 v1.0 | 应用价值分析 | `../deliverables/幽灵通道协议_应用价值深度探索_v1.0.md` |
| 幽灵通道协议 技术演进路线图 v1.0 | 技术演进与 AI 应用路线图 | `../strategy/幽灵通道协议_技术演进与 AI 应用路线图_v1.0.md` |

> **注意**：ghost-channel/（protocol/sdk/poc）、papers/ 等目录在精简重构中已移除。
> 相关协议规范、RFC 草案、SDK 代码等资产的历史记录保留在本索引中供参考。
